        ...
        function displayNotes1() {
          ...
          function displayNotes2() {
            const storedNotes2 = localStorage.getItem("notes2");
            if (storedNotes2 !== null) {
              notes2 = JSON.parse(storedNotes2);
            }
            console.log(notes2);
